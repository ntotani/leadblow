...
xcrun -sdk iphoneos7.1 PackageApplication -v $DIR/DerivedData/$PROJ/Build/Products/$CONF-iphoneos/$PROJ_iOS.app -o $DIR/DerivedData/$PROJ/Build/Products/$CONF-iphoneos/$PROJ_iOS.ipa --embed $DIR/$MPROV --sign "iPhone Distribution: Maho Tsutsui (4VK3MQNCVY)"
